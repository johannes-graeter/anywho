...
// configuration step. It creates a namespace called `anywho`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", anywho::cmake::project_name, anywho::cmake::project_version) };
